 ...
 *****************************************************************************/
 ...
 We implement binary search as normal, then when we find our first instance of a
 key at mid, we set 'high' equal to mid and continue scanning, only considering
 the key at mid as the first index when low and mid are equal.
...
Tony and I worked equally on the project. 
